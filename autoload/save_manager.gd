extends Node
## Persistência do save em user://save.json.
## CLAUDE.md / especificacao_tecnica_v1.md #18-23: JSON versionado, debounce de 2s,
## backup rotativo de 3, migração em cadeia.
...
## Chamado pelos sistemas de jogo a cada ação relevante (construir, alocar, vender...).
## Não escreve em disco imediatamente — aguarda o debounce.
